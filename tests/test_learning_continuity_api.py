...
class LearningContinuityApiTests(unittest.TestCase):
    ...
    def test_platform_review_queue_returns_due_items(self) -> None:
        ...
        with patch("app.api.routes.public_learning.list_due_review_queue", return_value=payload):
    ...
    def test_platform_review_resume_returns_problem_payload(self) -> None:
        ...
        with patch("app.api.routes.public_learning.resume_review_queue_item", return_value=payload):
    ...
    def test_platform_review_resume_returns_404_when_missing(self) -> None:
        with patch("app.api.routes.public_learning.resume_review_queue_item", side_effect=LookupError("missing")):
    ...
    def test_me_goal_get_returns_serialized_goal(self) -> None:
        ...
        with (
            patch("app.api.routes.me.get_or_create_learning_goal", return_value=SimpleNamespace()),
            patch("app.api.routes.me.serialize_learning_goal", return_value=serialized),
        ):
    ...
    def test_me_goal_put_updates_goal(self) -> None:
        serialized = {
            ...
            "focusModes": ["analysis", "code-calc"],
            "focusTopics": ["로직 오류", "문법 오류"],
            "updatedAt": "2026-03-06T12:30:00",
        }
        with (
            patch("app.api.routes.me.update_learning_goal", return_value=SimpleNamespace()) as mock_update,
            patch("app.api.routes.me.serialize_learning_goal", return_value=serialized),
        ):
            response = self.client.put(
                ...
                json={
                    ...
                    "focus_modes": ["analysis", "code-calc"],
