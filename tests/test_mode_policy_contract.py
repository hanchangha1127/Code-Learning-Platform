...
from app.services import auditor_service, code_blame_service, context_inference_service, refactoring_choice_service
...
class ModePolicyContractTests(unittest.TestCase):
    def test_pass_threshold_is_shared(self):
        ...
        self.assertEqual(learning_mode_handlers.CONTEXT_INFERENCE_PASS_THRESHOLD, MODE_PASS_THRESHOLD)
        ...
        self.assertEqual(context_inference_service.CONTEXT_INFERENCE_PASS_THRESHOLD, MODE_PASS_THRESHOLD)
    ...
    def test_context_inference_policy_is_shared(self):
        self.assertEqual(learning_mode_handlers.CONTEXT_INFERENCE_TYPE_WEIGHTS, CONTEXT_INFERENCE_TYPE_WEIGHTS)
        self.assertEqual(
            learning_mode_handlers.CONTEXT_INFERENCE_COMPLEXITY_PROFILE_BY_DIFFICULTY,
            CONTEXT_INFERENCE_COMPLEXITY_PROFILE_BY_DIFFICULTY,
        )
