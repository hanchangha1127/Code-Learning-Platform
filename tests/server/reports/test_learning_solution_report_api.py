...
import server.features.learning.api_public_learning as public_learning_route
import server.features.reports.api as platform_reports_route
...
class LearningSolutionReportApiTests(unittest.TestCase):
    ...
    def test_platform_report_returns_latest_stored_schema(self) -> None:
        ...
        with patch.object(public_learning_route.learning_service, "get_public_report", return_value=payload):
    ...
    def test_platform_report_returns_404_when_no_stored_report_exists(self) -> None:
        with patch.object(
            public_learning_route.learning_service,
            "get_public_report",
