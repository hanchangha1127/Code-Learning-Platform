...
from server.features.learning.refactoring_choice_service import (
...
from server.schemas.runtime import RefactoringChoiceSubmitRequest
...
class RefactoringChoiceSqlSubmitTests(unittest.TestCase):
    ...
    def test_submit_report_updates_submission_and_analysis(self):
        ...
        with (
            patch("server.features.learning.refactoring_choice_service._ai_client.analyze_refactoring_choice_report", return_value=evaluation),
            patch("server.features.learning.refactoring_choice_service.update_user_problem_stat") as mock_stat_update,
        ):
    ...
    def test_submit_ai_failure_returns_fallback_response(self):
        with (
            patch(
                "server.features.learning.refactoring_choice_service._ai_client.analyze_refactoring_choice_report",
    ...
    def test_create_problem_generation_failure_returns_user_friendly_error(self):
        ...
        with patch(
            "server.features.learning.refactoring_choice_service._generator.generate_refactoring_choice_problem_sync",
