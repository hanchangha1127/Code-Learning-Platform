...
from app.api.routes.submissions import analyze, get_analyses
...
class SubmissionApiTests(unittest.TestCase):
    def test_get_analyses_returns_404_when_submission_is_missing(self):
        with patch(
            "app.api.routes.submissions.list_analyses_for_submission",
    ...
    def test_analyze_allows_retry_after_error_status(self):
        ...
        with patch("app.api.routes.submissions.is_rq_enabled", return_value=False):
            response = analyze(
                submission_id=11,
