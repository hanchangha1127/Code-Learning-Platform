...
from backend.mode_normalization import (
    ...
    normalize_option_id as _shared_normalize_option_id,
...
def _normalize_option_id(value: Any) -> str:
    return _shared_normalize_option_id(
        value,
...
def _normalize_option_reviews(value: Any) -> list[dict[str, str]]:
...
def create_refactoring_choice_problem(
    ...
    *,
    ...
    best_option = _normalize_option_id(generated.get("best_option"))
    option_reviews = _normalize_option_reviews(generated.get("option_reviews"))
...
def submit_refactoring_choice_report(
    ...
    *,
    ...
    constraints = _normalize_str_list(options_json.get("constraints"))
    choice_options = _normalize_options(options_json.get("options"))
    decision_facets = _normalize_decision_facets(options_json.get("decision_facets"))
    best_option = _normalize_option_id(options_json.get("best_option"))
    reference_report = str(options_json.get("reference_report") or problem.reference_solution or "").strip()
    option_reviews = _normalize_option_reviews(options_json.get("option_reviews"))
