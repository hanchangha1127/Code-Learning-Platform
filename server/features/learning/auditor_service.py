...
def submit_auditor_report(
    ...
    *,
    ...
    expected_trap_types = normalize_trap_types(trap_catalog)
    try:
    ...
    found_types = normalize_str_list(evaluation.get("found_types"))
    missed_types = normalize_str_list(evaluation.get("missed_types"))
